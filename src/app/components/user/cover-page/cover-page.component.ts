...
export class CoverPageComponent implements OnInit{
  ...
  getCoverPage() {
    if (this.selectedFile) {
      ...
      // formData.append('job_desc_text', this.userCV.email_id);
        ...
        next: (resp: any) => {
          if (resp) {
            ...
            this.authService.puttCV(data).subscribe({
              next: (resp: any) => {
                this.alertService.showAlert('success', 'Cover Page generated successfully!');
              },
              error: (HttpResponse: HttpErrorResponse) => {
                console.log(HttpResponse);
                this.alertService.showAlert('danger', 'Cover Page generation failed!');
              }
            });
          }
        },
